          ...
          <div className="bg-gradient-to-br from-amber-300/30 to-amber-200/30 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/20 relative overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="relative space-y-5">
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full h-12 pl-12 pr-14 bg-white rounded-2xl text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-4 focus:ring-orange-500/50 focus:border-orange-500 shadow-lg transition-all duration-300 border-2 border-white/30"
                      required
                      disabled={isLoading}
                      minLength={8}
                    />
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full h-14 bg-gradient-to-r from-orange-500 to-orange-400 text-white font-semibold rounded-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >
                {isLoading ? (
