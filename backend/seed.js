...
async function seedData() {
  try {
    await mongoose.connect("mongodb+srv://mohamedshafik2526:ShafikMongo12345@cluster1.djqnrpm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster1", {
  ...
  deliveryTime:"30-45"});
    ...
    await MenuItem.create({
      ...
      price: 4.99,
      category: "Soups",
      image: "https://images.unsplash.com/photo-1606850196854-d13cdec95358?w=300&h=200&fit=crop",
      restaurant: r2._id
    });
  ...
  deliveryTime:"25-40"});
    ...
    await MenuItem.create({
      name: "Pad Thai",
      description: "Stir-fried rice noodles with shrimp, bean sprouts, and peanuts",
      price: 15.99,
      category: "Noodles",
